...
class NearEarthObject:
    ...
    """
    # WIP: How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, designation, name=None, diameter='nan', hazardous=False, **info):
        """Create a new `NearEarthObject`.

        :param info: A dictionary of excess keyword arguments supplied to the constructor.
        """
        # WIP: Assign information from the arguments passed to the constructor
    ...
    def fullname(self):
        ...
        # WIP: Use self.designation and self.name to build a fullname for this object.
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        """
        # WIP: Use this object's `.time` attribute and the `datetime_to_str` function to
        # build a formatted representation of the approach time.
        # WIP: Use self.designation and self.name to build a fullname for this object.
        return (f"{datetime_to_str(self.time)}"
                f"{self.neo.fullname}" if self.neo else '')
