...
class NearEarthObject:
    ...
    def __init__(self, designation, name=None, diameter='nan', hazardous=False, **info):
        ...
        :param designation: A designation of neo.
        :param name: A name of neo.
        :param diameter: A diameter of neo.
        :param hazardous: A flag of hazardous neo. True if hazardous otherwise False
